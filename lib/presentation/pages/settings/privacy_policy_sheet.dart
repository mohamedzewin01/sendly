...
class _PrivacySheet extends StatelessWidget {
  ...
  static const List<(IconData, String, String)> _highlights = [
    ...
    (
      ...
      'الإعلانات',
      'يعرض التطبيق إعلانات عبر Google AdMob: بانرات صغيرة داخل الصفحات والقوائم، وإعلاناً بينياً بعد العودة من تطبيق المراسلة وأحياناً عند التنقل بين الأقسام بفواصل زمنية (لا يظهر عند فتح التطبيق ولا أثناء الكتابة)، وعرضاً بمكافأة عند فتح الإعدادات مع خيار الرفض. '
          'ويمكنك اختيارياً مشاهدة إعلان أو إعلانين أو ثلاثة من الإعدادات لإخفاء الإعلانات 3 أو 6 أو 12 ساعة. '
